...
while choice != "0":
    ...
    if choice == "0":
        ...
        for name_and_surname_son in pair_son_dad:
                ...
                if pair_son_dad[name_and_surname_son] == dad:

                    grandson = name_and_surname_son

                    print("\nThe Grandson of " + grandfather + " is: " + grandson)

        print("\n If there isn't any results, It means: \"I don't have any pair of names son, dad and grandfather in database.\"")
